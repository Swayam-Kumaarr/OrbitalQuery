...
const MAX_RETRIES = 1; // One retry — enough for Render cold start with 25s wait
const RETRY_DELAY_MS = 25000; // 25s wait for Render free tier cold start (service typically wakes in 30-60s)
